...
async function runMigrations(db) {
  ...
  try {
    ...
    const oldTickets = data.rows.map((r) => ({ id: r.id, name: r.name, remaining: r.remaining, expiry_date: r.expiry_date }));
...
export { getRow as a, getDb as g, initSchema as i };
